...
SECRET_KEY = "django-insecure-e7536lj30huyu+@#&fc(w&81-rm#gau75=^!fyr(5x0ro$=8x-"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Cho phép truy cập từ mọi host

# Cấu hình port
PORT = 8006

# Cấu hình các service URL
GATEWAY_URL = os.environ.get('GATEWAY_URL', 'http://gateway:8080')
CLINICAL_SERVICE_URL = GATEWAY_URL  # Sử dụng gateway thay vì kết nối trực tiếp
